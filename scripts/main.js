const customNameTextInput = document.querySelector('#customname');
const generateRandomStoryButton = document.querySelector('.randomize');
...
generateRandomStoryButton.addEventListener('click', result);
...
function result() {
    ...
    if(customNameTextInput.value !== '') {
        const name = customNameTextInput.value;
